...
const [formData, setFormData]=useState({})
  ...
  <div class="mb-5">
      ...
      <input type="text" id="discription" onChange={handleChange}  class="block w-full p-4 text-black-900 border border-black-300 rounded-lg bg-black-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-black-700 dark:border-black-600 dark:placeholder-black-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
  </div>
    ...
    <div className=''>
      ...
      <input type="text" id="tags" onChange={handleChange}  class="block w-full p-4 text-black-900 border border-black-300 rounded-lg bg-black-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-black-700 dark:border-black-600 dark:placeholder-black-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
              </div>
     <div class="mb-5">
      <label  class="block mb-2 text-sm font-medium text-white-900 dark:text-gray">Priority</label>
  <select id="Priority" onChange={handleChange}  class="bg-white-50 border border-gray-300 text-white-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500">
